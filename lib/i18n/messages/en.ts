...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "mobile.menu": "Pi Web mobile menu",
    ...
    "devices.offlineHint": "Pi Web does not poll in the background or move tasks automatically. It checks once only after an action fails, when switching devices, or when you ask it to check again.",
