...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "devices.checkingAvailability": "正在检查设备状态",
    "devices.checkingAvailabilityDescription": "正在查找可用的执行设备",
    "devices.offlineTitle": "{name} 已离线",
    "devices.offlineDescription": "Pi Web 入口仍然可用。请选择另一台设备继续，无需清除站点数据。",
    "devices.switchToAvailable": "切换到 {name}",
    "devices.checkAgain": "重新检查",
    "devices.offlineHint": "在你主动选择前，任务不会迁移，也不会在另一台设备上运行。",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "切换到浅色模式",
    "theme.dark": "切换到深色模式",
    ...
    "chat.pushUnsupported": "请先将 Pi Web 添加到主屏幕，再开启推送",
