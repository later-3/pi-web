...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "devices.checkingAvailability": "Checking device availability",
    "devices.checkingAvailabilityDescription": "Finding an online execution device",
    "devices.offlineTitle": "{name} is offline",
    "devices.offlineDescription": "Pi Web is still available. Choose another device to continue without clearing site data.",
    "devices.switchToAvailable": "Switch to {name}",
    "devices.checkAgain": "Check again",
    "devices.offlineHint": "No task will be moved or run on another device until you choose it.",
